...
根据输入的v8，比对result是否和v9一样

### Phase_4

可以用python写一下func4的代码，或者直接让v8=7让返回结果是0就行

### Phase_5

![image-20200906215307237](img/image-20200906215307237.png)

![image-20200906215354052](img/image-20200906215354052.png)

赋值这里，由于会和 0xF与一下，所以为了使结果是flyers，输入`9on567`即可在这个数组中取得对应的字幕

```
o = 0110 1111 
o & 0xf = 0000 1111 = 16 = 0xf
n = 0110 1110
n & 0xf = 0000 1110 = 15 = 0xe
```
